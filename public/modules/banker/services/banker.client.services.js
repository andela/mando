'use strict';
angular.module('banker').factory('bankerServices', [ 'BANKERCONST',
...
var getAllBalance = function(){
  return $http.get(url+'/',); //the Http request for the  entire Organisation banker with a get request
};
